            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Teks <?php echo form_error('teks') ?></label>
                          <div class="col-sm-12 col-md-10">
                            <input type="text" class="form-control" readonly name="teks" id="teks" placeholder="Teks" value="<?php echo $teks; ?>" />
                          </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" rows="3" readonly name="cleaning" id="cleaning" placeholder="Cleaning"><?php echo $cleaning; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" rows="3" readonly name="casefolding" id="casefolding" placeholder="Casefolding"><?php echo $casefolding; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" rows="3" readonly name="tokenizing" id="tokenizing" placeholder="Tokenizing"><?php echo $tokenizing; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" rows="3" readonly name="stemming" id="stemming" placeholder="Stemming"><?php echo $stemming; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" rows="3" readonly name="rekomendasi" id="rekomendasi" placeholder="Rekomendasi"><?php echo $rekomendasi; ?></textarea>
                        </div>
                    </div>
